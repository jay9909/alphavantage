...
// This file was generated on 2023-05-17 00:48:47
...
// -	adjusted: By default, <code>adjusted=true</code> and the output time series is adjusted by historical split and dividend events. Set <code>adjusted=false</code> to query raw (as-traded) intraday values.
// -	outputsize: By default, <code>outputsize=compact</code>. Strings <code>compact</code> and <code>full</code> are accepted with the following specifications: <code>compact</code> returns only the latest 100 data points in the intraday time series; <code>full</code> returns the full-length intraday time series. The &#34;compact&#34; option is recommended if you would like to reduce the data size of each API call.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the intraday time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesIntraday(symbol, interval, adjusted, outputsize, datatype string) (*http.Response, error) {
...
// -	adjusted: By default, <code>adjusted=true</code> and the output time series is adjusted by historical split and dividend events. Set <code>adjusted=false</code> to query raw (as-traded) intraday values.
func (a *Alphavantage) GetTimeSeriesIntradayExtended(symbol, interval, slice, adjusted string) (*http.Response, error) {
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesDaily(symbol, outputsize, datatype string) (*http.Response, error) {
...
// -	outputsize: By default, <code>outputsize=compact</code>. Strings <code>compact</code> and <code>full</code> are accepted with the following specifications: <code>compact</code> returns only the latest 100 data points; <code>full</code> returns the full-length time series of 20+ years of historical data. The &#34;compact&#34; option is recommended if you would like to reduce the data size of each API call.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesDailyAdjusted(symbol, outputsize, datatype string) (*http.Response, error) {
...
// Parameters:
// -	symbol: The name of the equity of your choice. For example: <code>symbol=IBM</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the weekly time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesWeekly(symbol, datatype string) (*http.Response, error) {
...
// -	symbol: The name of the equity of your choice. For example: <code>symbol=IBM</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the weekly time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesWeeklyAdjusted(symbol, datatype string) (*http.Response, error) {
...
// Parameters:
// -	symbol: The name of the equity of your choice. For example: <code>symbol=IBM</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the monthly time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesMonthly(symbol, datatype string) (*http.Response, error) {
...
// -	symbol: The name of the equity of your choice. For example: <code>symbol=IBM</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the monthly time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesMonthlyAdjusted(symbol, datatype string) (*http.Response, error) {
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the quote data in JSON format; <code>csv</code> returns the quote data as a CSV (comma separated value) file.
func (a *Alphavantage) GetGlobalQuote(symbol, datatype string) (*http.Response, error) {
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the search results in JSON format; <code>csv</code> returns the search results as a CSV (comma separated value) file.
func (a *Alphavantage) GetSymbolSearch(keywords, datatype string) (*http.Response, error) {
...
//
// Parameters:
func (a *Alphavantage) GetMarketStatus(string) (*http.Response, error) {
...
//
// -	time_from: The time range of the news articles you are targeting, in YYYYMMDDTHHMM format. For example: <code>time_from=20220410T0130</code>. If time_from is specified but time_to is missing, the API will return articles published between the time_from value and the current time.
// -	sort: By default, <code>sort=LATEST</code> and the API will return the latest articles first. You can also set <code>sort=EARLIEST</code> or <code>sort=RELEVANCE</code> based on your use case.
// -	limit: By default, <code>limit=50</code> and the API will return up to 50 matching results. You can also set <code>limit=200</code> to output up to 200 results. If you are looking for an even higher output limit, please contact <a href="/cdn-cgi/l/email-protection" class="__cf_email__">[email protected]</a> to have your limit boosted.
func (a *Alphavantage) GetNewsSentiment(tickers, topics, time_from, sort, limit string) (*http.Response, error) {
...
func (a *Alphavantage) GetOverview(symbol string) (*http.Response, error) {
	function := "OVERVIEW"
	params := map[string]string{
		"symbol": symbol,
	}
...
// Parameters:
// -	symbol: The symbol of the token of your choice. For example: <code>symbol=IBM</code>.
func (a *Alphavantage) GetIncomeStatement(symbol string) (*http.Response, error) {
...
// Parameters:
// -	symbol: The symbol of the token of your choice. For example: <code>symbol=IBM</code>.
func (a *Alphavantage) GetBalanceSheet(symbol string) (*http.Response, error) {
...
// Parameters:
// -	symbol: The symbol of the token of your choice. For example: <code>symbol=IBM</code>.
func (a *Alphavantage) GetCashFlow(symbol string) (*http.Response, error) {
	function := "CASH_FLOW"
	params := map[string]string{
		"symbol": symbol,
	}
...
// Parameters:
// -	symbol: The symbol of the token of your choice. For example: <code>symbol=IBM</code>.
func (a *Alphavantage) GetEarnings(symbol string) (*http.Response, error) {
	function := "EARNINGS"
	params := map[string]string{
		"symbol": symbol,
	}
...
// -	state: By default, <code>state=active</code> and the API will return a list of actively traded stocks and ETFs. Set <code>state=delisted</code> to query a list of delisted assets.
func (a *Alphavantage) GetListingStatus(date, state string) (*http.Response, error) {
...
//
// Parameters:
// -	symbol: By default, no symbol will be set for this API. When no symbol is set, the API endpoint will return the full list of company earnings scheduled. If a symbol is set, the API endpoint will return the expected earnings for that specific symbol. For example, <code>symbol=IBM</code>
// -	horizon: By default, <code>horizon=3month</code> and the API will return a list of expected company earnings in the next 3 months. You may set <code>horizon=6month</code> or <code>horizon=12month</code> to query the earnings scheduled for the next 6 months or 12 months, respectively.
func (a *Alphavantage) GetEarningsCalendar(symbol, horizon string) (*http.Response, error) {
...
//
// Parameters:
func (a *Alphavantage) GetIpoCalendar(string) (*http.Response, error) {
...
func (a *Alphavantage) GetCurrencyExchangeRate(from_currency, to_currency string) (*http.Response, error) {
...
// -	outputsize: By default, <code>outputsize=compact</code>. Strings <code>compact</code> and <code>full</code> are accepted with the following specifications: <code>compact</code> returns only the latest 100 data points in the intraday time series; <code>full</code> returns the full-length intraday time series. The &#34;compact&#34; option is recommended if you would like to reduce the data size of each API call.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the intraday time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetFxIntraday(from_symbol, to_symbol, interval, outputsize, datatype string) (*http.Response, error) {
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetFxDaily(from_symbol, to_symbol, outputsize, datatype string) (*http.Response, error) {
	function := "FX_DAILY"
	params := map[string]string{
		"from_symbol": from_symbol,
		"to_symbol":   to_symbol,
...
// -	to_symbol: A three-letter symbol from the <a href="https://www.alphavantage.co/physical_currency_list/" target="_blank"> forex currency list</a>. For example: <code>to_symbol=USD</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the weekly time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetFxWeekly(from_symbol, to_symbol, datatype string) (*http.Response, error) {
	function := "FX_WEEKLY"
	params := map[string]string{
		"from_symbol": from_symbol,
		"to_symbol":   to_symbol,
...
// -	to_symbol: A three-letter symbol from the <a href="https://www.alphavantage.co/physical_currency_list/" target="_blank"> forex currency list</a>. For example: <code>to_symbol=USD</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the monthly time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetFxMonthly(from_symbol, to_symbol, datatype string) (*http.Response, error) {
	function := "FX_MONTHLY"
	params := map[string]string{
		"from_symbol": from_symbol,
		"to_symbol":   to_symbol,
...
// -	outputsize: By default, <code>outputsize=compact</code>. Strings <code>compact</code> and <code>full</code> are accepted with the following specifications: <code>compact</code> returns only the latest 100 data points in the intraday time series; <code>full</code> returns the full-length intraday time series. The &#34;compact&#34; option is recommended if you would like to reduce the data size of each API call.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the intraday time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCryptoIntraday(symbol, market, interval, outputsize, datatype string) (*http.Response, error) {
...
func (a *Alphavantage) GetDigitalCurrencyDaily(symbol, market string) (*http.Response, error) {
...
// -	symbol: The digital/crypto currency of your choice. It can be any of the currencies in the <a href="https://www.alphavantage.co/digital_currency_list/" target="_blank"> digital currency list</a>. For example: <code>symbol=BTC</code>.
// -	market: The exchange market of your choice. It can be any of the market in the <a href="https://www.alphavantage.co/physical_currency_list/" target="_blank"> market list</a>. For example: <code>market=CNY</code>.
func (a *Alphavantage) GetDigitalCurrencyWeekly(symbol, market string) (*http.Response, error) {
...
// -	symbol: The digital/crypto currency of your choice. It can be any of the currencies in the <a href="https://www.alphavantage.co/digital_currency_list/" target="_blank"> digital currency list</a>. For example: <code>symbol=BTC</code>.
// -	market: The exchange market of your choice. It can be any of the market in the <a href="https://www.alphavantage.co/physical_currency_list/" target="_blank"> market list</a>. For example: <code>market=CNY</code>.
func (a *Alphavantage) GetDigitalCurrencyMonthly(symbol, market string) (*http.Response, error) {
...
//
// Parameters:
// -	interval: By default, <code>interval=monthly</code>. Strings <code>daily</code>, <code>weekly</code>, and <code>monthly</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetWti(interval, datatype string) (*http.Response, error) {
	function := "WTI"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>daily</code>, <code>weekly</code>, and <code>monthly</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetBrent(interval, datatype string) (*http.Response, error) {
	function := "BRENT"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>daily</code>, <code>weekly</code>, and <code>monthly</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetNaturalGas(interval, datatype string) (*http.Response, error) {
...
//
// Parameters:
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCopper(interval, datatype string) (*http.Response, error) {
	function := "COPPER"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAluminum(interval, datatype string) (*http.Response, error) {
	function := "ALUMINUM"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetWheat(interval, datatype string) (*http.Response, error) {
	function := "WHEAT"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCorn(interval, datatype string) (*http.Response, error) {
	function := "CORN"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCotton(interval, datatype string) (*http.Response, error) {
	function := "COTTON"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetSugar(interval, datatype string) (*http.Response, error) {
	function := "SUGAR"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCoffee(interval, datatype string) (*http.Response, error) {
	function := "COFFEE"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAllCommodities(interval, datatype string) (*http.Response, error) {
...
//
// Parameters:
// -	interval: By default, <code>interval=annual</code>. Strings <code>quarterly</code> and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRealGdp(interval, datatype string) (*http.Response, error) {
	function := "REAL_GDP"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRealGdpPerCapita(datatype string) (*http.Response, error) {
...
// Parameters:
// -	interval: By default, <code>interval=monthly</code>. Strings <code>daily</code>, <code>weekly</code>, and <code>monthly</code> are accepted.
// -	maturity: By default, <code>maturity=10year</code>. Strings <code>3month</code>, <code>2year</code>, <code>5year</code>, <code>7year</code>, <code>10year</code>, and <code>30year</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTreasuryYield(interval, maturity, datatype string) (*http.Response, error) {
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>daily</code>, <code>weekly</code>, and <code>monthly</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetFederalFundsRate(interval, datatype string) (*http.Response, error) {
...
//
// Parameters:
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code> and <code>semiannual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCpi(interval, datatype string) (*http.Response, error) {
	function := "CPI"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetInflation(datatype string) (*http.Response, error) {
	function := "INFLATION"
	params := map[string]string{
		"datatype": datatype,
	}
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRetailSales(datatype string) (*http.Response, error) {
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetDurables(datatype string) (*http.Response, error) {
	function := "DURABLES"
	params := map[string]string{
		"datatype": datatype,
	}
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetUnemployment(datatype string) (*http.Response, error) {
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetNonfarmPayroll(datatype string) (*http.Response, error) {
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetSma(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "SMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetEma(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "EMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetWma(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "WMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetDema(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "DEMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTema(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "TEMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTrima(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "TRIMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetKama(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "KAMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	fastlimit: Positive floats are accepted. By default, <code>fastlimit=0.01</code>.
// -	slowlimit: Positive floats are accepted. By default, <code>slowlimit=0.01</code>.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMama(symbol, interval, series_type, fastlimit, slowlimit, datatype string) (*http.Response, error) {
	function := "MAMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetVwap(symbol, interval, datatype string) (*http.Response, error) {
	function := "VWAP"
	params := map[string]string{
		"symbol":   symbol,
		"interval": interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetT3(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "T3"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	fastperiod: Positive integers are accepted. By default, <code>fastperiod=12</code>.
// -	slowperiod: Positive integers are accepted. By default, <code>slowperiod=26</code>.
// -	signalperiod: Positive integers are accepted. By default, <code>signalperiod=9</code>.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMacd(symbol, interval, series_type, fastperiod, slowperiod, signalperiod, datatype string) (*http.Response, error) {
	function := "MACD"
	params := map[string]string{
		"symbol":       symbol,
		"interval":     interval,
...
// -	slowperiod: Positive integers are accepted. By default, <code>slowperiod=26</code>.
// -	signalperiod: Positive integers are accepted. By default, <code>signalperiod=9</code>.
// -	fastmatype: Moving average type for the faster moving average. By default, <code>fastmatype=0</code>. Integers 0 - 8 are accepted with the following mappings. 0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	slowmatype: Moving average type for the slower moving average. By default, <code>slowmatype=0</code>. Integers 0 - 8 are accepted with the following mappings. 0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	signalmatype: Moving average type for the signal moving average. By default, <code>signalmatype=0</code>. Integers 0 - 8 are accepted with the following mappings. 0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMacdext(symbol, interval, series_type, fastperiod, slowperiod, signalperiod, fastmatype, slowmatype, signalmatype, datatype string) (*http.Response, error) {
	function := "MACDEXT"
	params := map[string]string{
		"symbol":       symbol,
		"interval":     interval,
...
// -	symbol: The name of the token of your choice. For example: <code>symbol=IBM</code>
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	fastkperiod: The time period of the fastk moving average. Positive integers are accepted. By default, <code>fastkperiod=5</code>.
// -	slowkperiod: The time period of the slowk moving average. Positive integers are accepted. By default, <code>slowkperiod=3</code>.
// -	slowdperiod: The time period of the slowd moving average. Positive integers are accepted. By default, <code>slowdperiod=3</code>.
// -	slowkmatype: Moving average type for the slowk moving average. By default, <code>slowkmatype=0</code>. Integers 0 - 8 are accepted with the following mappings. 0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	slowdmatype: Moving average type for the slowd moving average. By default, <code>slowdmatype=0</code>. Integers 0 - 8 are accepted with the following mappings. 0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetStoch(symbol, interval, fastkperiod, slowkperiod, slowdperiod, slowkmatype, slowdmatype, datatype string) (*http.Response, error) {
	function := "STOCH"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	fastkperiod: The time period of the fastk moving average. Positive integers are accepted. By default, <code>fastkperiod=5</code>.
// -	fastdperiod: The time period of the fastd moving average. Positive integers are accepted. By default, <code>fastdperiod=3</code>.
// -	fastdmatype: Moving average type for the fastd moving average. By default, <code>fastdmatype=0</code>. Integers 0 - 8 are accepted with the following mappings. 0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetStochf(symbol, interval, fastkperiod, fastdperiod, fastdmatype, datatype string) (*http.Response, error) {
	function := "STOCHF"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRsi(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "RSI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	fastdmatype: Moving average type for the fastd moving average. By default, <code>fastdmatype=0</code>. Integers 0 - 8 are accepted with the following mappings.  0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetStochrsi(symbol, interval, time_period, series_type, fastkperiod, fastdperiod, fastdmatype, datatype string) (*http.Response, error) {
	function := "STOCHRSI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetWillr(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "WILLR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAdx(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "ADX"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAdxr(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "ADXR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	fastperiod: Positive integers are accepted. By default, <code>fastperiod=12</code>.
// -	slowperiod: Positive integers are accepted. By default, <code>slowperiod=26</code>.
// -	matype: Moving average type. By default, <code>matype=0</code>. Integers 0 - 8 are accepted with the following mappings. 0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetApo(symbol, interval, series_type, fastperiod, slowperiod, matype, datatype string) (*http.Response, error) {
	function := "APO"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	matype: Moving average type. By default, <code>matype=0</code>. Integers 0 - 8 are accepted with the following mappings. 0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetPpo(symbol, interval, series_type, fastperiod, slowperiod, matype, datatype string) (*http.Response, error) {
	function := "PPO"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMom(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "MOM"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetBop(symbol, interval, datatype string) (*http.Response, error) {
	function := "BOP"
	params := map[string]string{
		"symbol":   symbol,
		"interval": interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCci(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "CCI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCmo(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "CMO"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRoc(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "ROC"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRocr(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "ROCR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAroon(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "AROON"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAroonosc(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "AROONOSC"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMfi(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "MFI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTrix(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "TRIX"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	symbol: The name of the token of your choice. For example: <code>symbol=IBM</code>
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	timeperiod1: The first time period for the indicator. Positive integers are accepted. By default, <code>timeperiod1=7</code>.
// -	timeperiod2: The second time period for the indicator. Positive integers are accepted. By default, <code>timeperiod2=14</code>.
// -	timeperiod3: The third time period for the indicator. Positive integers are accepted. By default, <code>timeperiod3=28</code>.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetUltosc(symbol, interval, timeperiod1, timeperiod2, timeperiod3, datatype string) (*http.Response, error) {
	function := "ULTOSC"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetDx(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "DX"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMinusDi(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "MINUS_DI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetPlusDi(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "PLUS_DI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMinusDm(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "MINUS_DM"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetPlusDm(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "PLUS_DM"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	nbdevup: The standard deviation multiplier of the upper band. Positive integers are accepted. By default, <code>nbdevup=2</code>.
// -	nbdevdn: The standard deviation multiplier of the lower band. Positive integers are accepted. By default, <code>nbdevdn=2</code>.
// -	matype: Moving average type of the time series. By default, <code>matype=0</code>. Integers 0 - 8 are accepted with the following mappings. 0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetBbands(symbol, interval, time_period, series_type, nbdevup, nbdevdn, matype, datatype string) (*http.Response, error) {
	function := "BBANDS"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMidpoint(symbol, interval, time_period, series_type, datatype string) (*http.Response, error) {
	function := "MIDPOINT"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMidprice(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "MIDPRICE"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	symbol: The name of the token of your choice. For example: <code>symbol=IBM</code>
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	acceleration: The acceleration factor. Positive floats are accepted. By default, <code>acceleration=0.01</code>.
// -	maximum: The acceleration factor maximum value. Positive floats are accepted. By default, <code>maximum=0.20</code>.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetSar(symbol, interval, acceleration, maximum, datatype string) (*http.Response, error) {
	function := "SAR"
	params := map[string]string{
		"symbol":       symbol,
		"interval":     interval,
...
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTrange(symbol, interval, datatype string) (*http.Response, error) {
	function := "TRANGE"
	params := map[string]string{
		"symbol":   symbol,
		"interval": interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAtr(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "ATR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetNatr(symbol, interval, time_period, datatype string) (*http.Response, error) {
	function := "NATR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAd(symbol, interval, datatype string) (*http.Response, error) {
	function := "AD"
	params := map[string]string{
		"symbol":   symbol,
		"interval": interval,
...
// -	symbol: The name of the token of your choice. For example: <code>symbol=IBM</code>
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	fastperiod: The time period of the fast EMA. Positive integers are accepted. By default, <code>fastperiod=3</code>.
// -	slowperiod: The time period of the slow EMA. Positive integers are accepted. By default, <code>slowperiod=10</code>.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAdosc(symbol, interval, fastperiod, slowperiod, datatype string) (*http.Response, error) {
	function := "ADOSC"
	params := map[string]string{
		"symbol":     symbol,
		"interval":   interval,
...
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetObv(symbol, interval, datatype string) (*http.Response, error) {
	function := "OBV"
	params := map[string]string{
		"symbol":   symbol,
		"interval": interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtTrendline(symbol, interval, series_type, datatype string) (*http.Response, error) {
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtSine(symbol, interval, series_type, datatype string) (*http.Response, error) {
	function := "HT_SINE"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtTrendmode(symbol, interval, series_type, datatype string) (*http.Response, error) {
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtDcperiod(symbol, interval, series_type, datatype string) (*http.Response, error) {
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtDcphase(symbol, interval, series_type, datatype string) (*http.Response, error) {
	function := "HT_DCPHASE"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtPhasor(symbol, interval, series_type, datatype string) (*http.Response, error) {
	function := "HT_PHASOR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
