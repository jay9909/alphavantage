...
// This file was generated on 2023-05-17 14:08:34
...
func (a *Alphavantage) GetListingStatus(date, state string) api.Response {
...
func (a *Alphavantage) GetEarningsCalendar(symbol, horizon string) api.Response {
...
func (a *Alphavantage) GetFxIntraday(from_symbol, to_symbol, interval, outputsize, datatype string) api.Response {
...
func (a *Alphavantage) GetFxDaily(from_symbol, to_symbol, outputsize, datatype string) api.Response {
	function := "FX_DAILY"
	params := map[string]string{
		"from_symbol": from_symbol,
		"to_symbol":   to_symbol,
...
func (a *Alphavantage) GetFxWeekly(from_symbol, to_symbol, datatype string) api.Response {
	function := "FX_WEEKLY"
	params := map[string]string{
		"from_symbol": from_symbol,
		"to_symbol":   to_symbol,
...
func (a *Alphavantage) GetFxMonthly(from_symbol, to_symbol, datatype string) api.Response {
	function := "FX_MONTHLY"
	params := map[string]string{
		"from_symbol": from_symbol,
		"to_symbol":   to_symbol,
...
// -	outputsize: By default, <code>outputsize=compact</code>. Strings <code>compact</code> and <code>full</code> are accepted with the following specifications: <code>compact</code> returns only the latest 100 data points in the intraday time series; <code>full</code> returns the full-length intraday time series. The &#34;compact&#34; option is recommended if you would like to reduce the data size of each API call.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the intraday time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCryptoIntraday(symbol, market, interval, outputsize, datatype string) api.Response {
...
func (a *Alphavantage) GetWti(interval, datatype string) api.Response {
	function := "WTI"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>daily</code>, <code>weekly</code>, and <code>monthly</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetBrent(interval, datatype string) api.Response {
	function := "BRENT"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>daily</code>, <code>weekly</code>, and <code>monthly</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetNaturalGas(interval, datatype string) api.Response {
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCopper(interval, datatype string) api.Response {
	function := "COPPER"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAluminum(interval, datatype string) api.Response {
	function := "ALUMINUM"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetWheat(interval, datatype string) api.Response {
	function := "WHEAT"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCorn(interval, datatype string) api.Response {
	function := "CORN"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCotton(interval, datatype string) api.Response {
	function := "COTTON"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetSugar(interval, datatype string) api.Response {
	function := "SUGAR"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCoffee(interval, datatype string) api.Response {
	function := "COFFEE"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>monthly</code>, <code>quarterly</code>, and <code>annual</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAllCommodities(interval, datatype string) api.Response {
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRealGdp(interval, datatype string) api.Response {
	function := "REAL_GDP"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRealGdpPerCapita(datatype string) api.Response {
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTreasuryYield(interval, maturity, datatype string) api.Response {
...
// -	interval: By default, <code>interval=monthly</code>. Strings <code>daily</code>, <code>weekly</code>, and <code>monthly</code> are accepted.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetFederalFundsRate(interval, datatype string) api.Response {
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCpi(interval, datatype string) api.Response {
	function := "CPI"
	params := map[string]string{
		"interval": interval,
		"datatype": datatype,
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetInflation(datatype string) api.Response {
	function := "INFLATION"
	params := map[string]string{
		"datatype": datatype,
	}
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRetailSales(datatype string) api.Response {
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetDurables(datatype string) api.Response {
	function := "DURABLES"
	params := map[string]string{
		"datatype": datatype,
	}
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetUnemployment(datatype string) api.Response {
...
// Parameters:
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetNonfarmPayroll(datatype string) api.Response {
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetSma(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "SMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetEma(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "EMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetWma(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "WMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetDema(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "DEMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTema(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "TEMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTrima(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "TRIMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetKama(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "KAMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMama(symbol, interval, series_type, fastlimit, slowlimit, datatype string) api.Response {
	function := "MAMA"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetVwap(symbol, interval, datatype string) api.Response {
	function := "VWAP"
	params := map[string]string{
		"symbol":   symbol,
		"interval": interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetT3(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "T3"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMacd(symbol, interval, series_type, fastperiod, slowperiod, signalperiod, datatype string) api.Response {
	function := "MACD"
	params := map[string]string{
		"symbol":       symbol,
		"interval":     interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMacdext(symbol, interval, series_type, fastperiod, slowperiod, signalperiod, fastmatype, slowmatype, signalmatype, datatype string) api.Response {
	function := "MACDEXT"
	params := map[string]string{
		"symbol":       symbol,
		"interval":     interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetStoch(symbol, interval, fastkperiod, slowkperiod, slowdperiod, slowkmatype, slowdmatype, datatype string) api.Response {
	function := "STOCH"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetStochf(symbol, interval, fastkperiod, fastdperiod, fastdmatype, datatype string) api.Response {
	function := "STOCHF"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRsi(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "RSI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	fastdmatype: Moving average type for the fastd moving average. By default, <code>fastdmatype=0</code>. Integers 0 - 8 are accepted with the following mappings.  0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetStochrsi(symbol, interval, time_period, series_type, fastkperiod, fastdperiod, fastdmatype, datatype string) api.Response {
	function := "STOCHRSI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetWillr(symbol, interval, time_period, datatype string) api.Response {
	function := "WILLR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAdx(symbol, interval, time_period, datatype string) api.Response {
	function := "ADX"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAdxr(symbol, interval, time_period, datatype string) api.Response {
	function := "ADXR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetApo(symbol, interval, series_type, fastperiod, slowperiod, matype, datatype string) api.Response {
	function := "APO"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	matype: Moving average type. By default, <code>matype=0</code>. Integers 0 - 8 are accepted with the following mappings. 0 = Simple Moving Average (SMA), 1 = Exponential Moving Average (EMA), 2 = Weighted Moving Average (WMA), 3 = Double Exponential Moving Average (DEMA), 4 = Triple Exponential Moving Average (TEMA), 5 = Triangular Moving Average (TRIMA), 6 = T3 Moving Average, 7 = Kaufman Adaptive Moving Average (KAMA), 8 = MESA Adaptive Moving Average (MAMA).
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetPpo(symbol, interval, series_type, fastperiod, slowperiod, matype, datatype string) api.Response {
	function := "PPO"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMom(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "MOM"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetBop(symbol, interval, datatype string) api.Response {
	function := "BOP"
	params := map[string]string{
		"symbol":   symbol,
		"interval": interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCci(symbol, interval, time_period, datatype string) api.Response {
	function := "CCI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetCmo(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "CMO"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRoc(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "ROC"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetRocr(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "ROCR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAroon(symbol, interval, time_period, datatype string) api.Response {
	function := "AROON"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAroonosc(symbol, interval, time_period, datatype string) api.Response {
	function := "AROONOSC"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMfi(symbol, interval, time_period, datatype string) api.Response {
	function := "MFI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTrix(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "TRIX"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetUltosc(symbol, interval, timeperiod1, timeperiod2, timeperiod3, datatype string) api.Response {
	function := "ULTOSC"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetDx(symbol, interval, time_period, datatype string) api.Response {
	function := "DX"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMinusDi(symbol, interval, time_period, datatype string) api.Response {
	function := "MINUS_DI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetPlusDi(symbol, interval, time_period, datatype string) api.Response {
	function := "PLUS_DI"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMinusDm(symbol, interval, time_period, datatype string) api.Response {
	function := "MINUS_DM"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetPlusDm(symbol, interval, time_period, datatype string) api.Response {
	function := "PLUS_DM"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetBbands(symbol, interval, time_period, series_type, nbdevup, nbdevdn, matype, datatype string) api.Response {
	function := "BBANDS"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMidpoint(symbol, interval, time_period, series_type, datatype string) api.Response {
	function := "MIDPOINT"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetMidprice(symbol, interval, time_period, datatype string) api.Response {
	function := "MIDPRICE"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetSar(symbol, interval, acceleration, maximum, datatype string) api.Response {
	function := "SAR"
	params := map[string]string{
		"symbol":       symbol,
		"interval":     interval,
...
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTrange(symbol, interval, datatype string) api.Response {
	function := "TRANGE"
	params := map[string]string{
		"symbol":   symbol,
		"interval": interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAtr(symbol, interval, time_period, datatype string) api.Response {
	function := "ATR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetNatr(symbol, interval, time_period, datatype string) api.Response {
	function := "NATR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAd(symbol, interval, datatype string) api.Response {
	function := "AD"
	params := map[string]string{
		"symbol":   symbol,
		"interval": interval,
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetAdosc(symbol, interval, fastperiod, slowperiod, datatype string) api.Response {
	function := "ADOSC"
	params := map[string]string{
		"symbol":     symbol,
		"interval":   interval,
...
// -	interval: Time interval between two consecutive data points in the time series. The following values are supported: <code>1min</code>, <code>5min</code>, <code>15min</code>, <code>30min</code>, <code>60min</code>, <code>daily</code>, <code>weekly</code>, <code>monthly</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetObv(symbol, interval, datatype string) api.Response {
	function := "OBV"
	params := map[string]string{
		"symbol":   symbol,
		"interval": interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtTrendline(symbol, interval, series_type, datatype string) api.Response {
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtSine(symbol, interval, series_type, datatype string) api.Response {
	function := "HT_SINE"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtTrendmode(symbol, interval, series_type, datatype string) api.Response {
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtDcperiod(symbol, interval, series_type, datatype string) api.Response {
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtDcphase(symbol, interval, series_type, datatype string) api.Response {
	function := "HT_DCPHASE"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	series_type: The desired price type in the time series. Four types are supported: <code>close</code>, <code>open</code>, <code>high</code>, <code>low</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetHtPhasor(symbol, interval, series_type, datatype string) api.Response {
	function := "HT_PHASOR"
	params := map[string]string{
		"symbol":      symbol,
		"interval":    interval,
...
// -	outputsize: By default, <code>outputsize=compact</code>. Strings <code>compact</code> and <code>full</code> are accepted with the following specifications: <code>compact</code> returns only the latest 100 data points in the intraday time series; <code>full</code> returns the full-length intraday time series. The &#34;compact&#34; option is recommended if you would like to reduce the data size of each API call.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the intraday time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesIntraday(symbol, interval, adjusted, outputsize, datatype string) api.Response {
...
// -	adjusted: By default, <code>adjusted=true</code> and the output time series is adjusted by historical split and dividend events. Set <code>adjusted=false</code> to query raw (as-traded) intraday values.
func (a *Alphavantage) GetTimeSeriesIntradayExtended(symbol, interval, slice, adjusted string) api.Response {
...
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesDaily(symbol, outputsize, datatype string) api.Response {
...
// -	outputsize: By default, <code>outputsize=compact</code>. Strings <code>compact</code> and <code>full</code> are accepted with the following specifications: <code>compact</code> returns only the latest 100 data points; <code>full</code> returns the full-length time series of 20+ years of historical data. The &#34;compact&#34; option is recommended if you would like to reduce the data size of each API call.
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the daily time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesDailyAdjusted(symbol, outputsize, datatype string) api.Response {
...
// -	symbol: The name of the equity of your choice. For example: <code>symbol=IBM</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the weekly time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesWeekly(symbol, datatype string) api.Response {
...
// -	symbol: The name of the equity of your choice. For example: <code>symbol=IBM</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the weekly time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesWeeklyAdjusted(symbol, datatype string) api.Response {
...
// -	symbol: The name of the equity of your choice. For example: <code>symbol=IBM</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the monthly time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesMonthly(symbol, datatype string) api.Response {
...
// -	symbol: The name of the equity of your choice. For example: <code>symbol=IBM</code>
// -	datatype: By default, <code>datatype=json</code>. Strings <code>json</code> and <code>csv</code> are accepted with the following specifications: <code>json</code> returns the monthly time series in JSON format; <code>csv</code> returns the time series as a CSV (comma separated value) file.
func (a *Alphavantage) GetTimeSeriesMonthlyAdjusted(symbol, datatype string) api.Response {
...
func (a *Alphavantage) GetGlobalQuote(symbol, datatype string) api.Response {
...
func (a *Alphavantage) GetSymbolSearch(keywords, datatype string) api.Response {
...
func (a *Alphavantage) GetNewsSentiment(tickers, topics, time_from, sort, limit string) api.Response {
